...
class BooksByGenreAdapter(private val books: List<BookListByGenreResponseModel.BookModel>): RecyclerView.Adapter<BooksByGenreAdapter.ViewHolder>(){
    ...
    inner class ViewHolder(view: View): RecyclerView.ViewHolder(view){
        ...
        private var book: BookListByGenreResponseModel.BookModel? = null
